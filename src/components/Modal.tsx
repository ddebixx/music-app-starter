    ...
    return (
        <Dialog.Root
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] max-h-full h-full w-full translate-x-[-50%] translate-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus:outline-none md:w-[90vw] md:max-w-[450px] md:h-auto md:max-h-[85vh]'>
